...
Dashboard bisnis dibuat untuk membantu Jaya Jaya Institut memonitor performa dan risiko dropout mahasiswa secara visual, mencakup:
...
**🔗 Link Dashboard:** **`https://projectdicoding.streamlit.app/`**

---

## Menjalankan Sistem Machine Learning

Prototype sistem machine learning dibangun menggunakan **Streamlit** dan model **Random Forest Classifier (biner: Dropout vs Graduate)**. Prototype memiliki 3 tab:
